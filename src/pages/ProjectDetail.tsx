      ...
      <div className="p-6 space-y-6">
        ...
        <div className="rounded-lg border border-warning/30 bg-warning/5 p-4 flex items-start gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            This test result was generated by AI and may be inaccurate. Review and validate the videos of each test execution before making decisions or sharing with others.
          </p>
        </div>
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button variant="glow" size="sm" onClick={() => setAddTestCasesOpen(true)}>
